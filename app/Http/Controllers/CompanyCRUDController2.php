 ...
 */
    public function index()
    {
        ...
        return view('companies2.index', $data);
    }
/**
 ...
 */
    public function store(Request $request)
    {
        ...
        $company->save();
        return redirect()->route('companies2.index')
 ...
 */
    ...
    {
        return view('companies2.show', compact('company'));
    }
/**
 ...
 */
    ...
    {
        return view('companies2.edit', compact('company'));
    }
/**
 ...
 */
  ...
  return redirect()->route('companies2.index')
  ->with('success', '対象のメールアドレスをチェックしてください。');
        }
    }
